...
import {
    FaTimes, FaStar, FaDownload, FaEye, FaShoppingCart, FaHeart, FaShare,
    ...
    return (
        <div className="bg-gray-100 rounded-lg p-4 h-96 flex flex-col">
            <div className="flex items-center justify-between mb-4">
                <h4 className="font-bold text-gray-900">Aperçu gratuit</h4>
            ...
            <div className="flex-1 relative bg-white rounded shadow-lg overflow-hidden">
                <img
                ...
                <div className="absolute inset-0 bg-black/10 flex items-center justify-center">
                    <div className="bg-white/90 px-4 py-2 rounded-full text-gray-600 font-medium">
                        ...
                        {paymentStep === 'method' && (
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                    {[
                                        { id: 'card', name: 'Carte bancaire', icon: <FaCreditCard />, desc: 'Visa, Mastercard, Amex' },
...
// Composant principal du modal d'aperçu
                        ...
                        <div className="flex items-start justify-between">
                            <div className="flex-1">
                                <div className="flex items-center gap-2 mb-2">
                                    <span className={`px-2 py-1 rounded text-sm text-white ${subject?.color}`}>
                                ...
                                <div className="flex items-center gap-4 text-gray-600">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <span>{resource.rating} ({resource.reviewsCount} avis)</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    onClick={onClose}
                                    className="p-3 rounded-full text-gray-400 hover:text-gray-600 hover:bg-gray-50 transition-colors"
                                >
                                    <FaTimes />
                                </button>
                            </div>
                            ...
                            <div className="flex border-b border-gray-200 mb-6">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center px-4 py-3 font-medium transition-colors ${activeTab === tab.id
                                                ...
                                                <div>
                                                    ...
                                                    <ul className="space-y-2 text-sm text-gray-600">
                                                        <li className="flex items-center">
                                                            ...
                                                            {resource.pages} pages au format PDF
                                                        </li>
                                                        <li className="flex items-center">
                                                            <FaCalendarAlt className="mr-2 text-purple-600" />
                                                            Accès pendant {resource.accessDuration} jours
                                                        </li>
                                                        <li className="flex items-center">
                                    ...
                                    <div className="mb-8">
                                        ...
                                        <div className="flex items-center gap-6 mb-6">
                                            <div className="text-center">
                                                <div className="text-4xl font-bold text-purple-600">{resource.rating}</div>
                                                <div className="flex text-yellow-400 justify-center mb-1">
                                                    {[...Array(5)].map((_, i) => (
                                                        <FaStar key={i} className={i < Math.floor(resource.rating) ? '' : 'text-gray-300'} />
                                                    ))}
                                                </div>
                                                <div className="text-sm text-gray-600">{resource.reviewsCount} avis</div>
                                            </div>
                                ...
                                <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
                                    ...
                                    <div className="space-y-3">
                                        <button
                                            ...
                                            className="w-full px-6 py-4 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl font-bold hover:shadow-xl transition-all transform hover:scale-105 flex items-center justify-center"
                                        >
                                            <FaShoppingCart className="mr-2" />
                                            Acheter maintenant
                                        </button>

                                        <button className="w-full px-6 py-3 border border-purple-600 text-purple-600 rounded-xl font-medium hover:bg-purple-50 transition-colors flex items-center justify-center">
                                    ...
                                    <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                                        ...
                                        <ul className="text-sm text-green-600 space-y-1">
                                            ...
                                            {resource.isPhysical && <li>• Livraison gratuite en France</li>}
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-xl shadow-lg p-6">
                                    ...
                                    <div className="space-y-3 text-sm">
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium">PDF téléchargeable</span>
                                        </div>
                                        <div className="flex justify-between">
